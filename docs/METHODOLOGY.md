...
Capacity was represented on a relative **0–100** scale. UGI class characteristics provided the ecological baseline, while vegetation condition retained within-class variation in vegetated areas. Built-up land was not subjected to an additional imperviousness penalty.
